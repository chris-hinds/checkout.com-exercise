...
Please note the project will not run locally without a secret key for the database. because of this I have a deployed the application here for testing. https://checkout-com-exercise-chris-hinds.vercel.app/
